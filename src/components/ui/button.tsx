...
const buttonVariants = cva(
  "leading-none inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg font-medium transition-colors focus-visible:outline-none disabled:pointer-events-none  btn",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-slate-100 text-slate-900 hover:text-slate-600 hover:bg-slate-200",
        ghost:
